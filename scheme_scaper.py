...
#         max_workers : int
#             Maximum number of concurrent workers for parallel scraping
#         delay : float
#             Base delay between requests (will be randomized slightly)
#         """
...
#             writer = csv.writer(f)
#             # Add URL and Scheme Name columns first, followed by target sections
...
#         url : str
#             URL of the page, used as fallback
            
#         Returns:
#         --------
#         str : The extracted scheme name or a default value
#         """
#         # Try several strategies to find the scheme name
...
#         if len(path_parts) > 0:
#             scheme_part = path_parts[-1] if path_parts[-1] else path_parts[-2]
#             # Clean up URL part
#             scheme_part = scheme_part.replace('-', ' ').replace('_', ' ')
#             return scheme_part.title()
...
#         -----------
#         url : str
#             URL of the scheme page to scrape
...
#                 "URL": url,
#                 "Scheme Name": "Error",
#                 **{section: f"Error: {str(e)}" for section in self.target_sections}
#             }
